...
class ExMonitor extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
      console.log("Not RenderingMonitor");
      return false;
  }
  ...
  processKinectBodies(){
    ...
    for (i =0 ; i<20; ++i) {
      ...
      this.populateKinectBodyParam(i,joint, this.bodyParam,cw,ch);
    }
    //Draw center body
    this.bodyParam.cx =tempx/25;
    this.bodyParam.cy =tempy/25;
  ...
  populateKinectBodyParam(i,joint,bodyParam,cw,ch){
    var cx =  joint.colorX*cw;
    var cy =  joint.colorY*ch
    switch(i) {
    // SPINE BASE
    case 0:
    bodyParam.scx = cx;
